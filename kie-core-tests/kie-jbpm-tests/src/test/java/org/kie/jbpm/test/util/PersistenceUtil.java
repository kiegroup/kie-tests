 ...
 */
package org.kie.jbpm.test.util;
...
public class PersistenceUtil {
    ...
    public static HashMap<String, Object> setupWithPoolingDataSource(String persistenceUnitName) {
        return setupWithPoolingDataSource(persistenceUnitName, "jdbc/jbpm-ds");
    }
     ...
     * 
     * @param context
     * A HashMap generated by {@link org.drools.persistence.util.PersistenceUtil setupWithPoolingDataSource(String)}
     * 
     */
    ...
    /**
     * This method uses the "jdbc/jbpm-ds" datasource, which is the default.
     * 
    ...
    public static PoolingDataSource setupPoolingDataSource(Properties dsProps) {
        return setupPoolingDataSource(dsProps, "jdbc/jbpm-ds");
    }
    ...
    private static class TestH2Server {
        ...
        public void start() {
            if (realH2Server == null || !realH2Server.isRunning(false)) {
                try {
                    DeleteDbFiles.execute("", "jbpm-test", true);
    ...
    public static StatefulKnowledgeSession createKnowledgeSessionFromKBase(KnowledgeBase kbase, HashMap<String, Object> context) {
        ...
        StatefulKnowledgeSession knowledgeSession = JPAKnowledgeService.newStatefulKnowledgeSession(kbase, ksconf,
