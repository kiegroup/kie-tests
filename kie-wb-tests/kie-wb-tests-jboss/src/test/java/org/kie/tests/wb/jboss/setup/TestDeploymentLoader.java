package org.kie.tests.wb.jboss.setup;
...
public class TestDeploymentLoader {
    ...
    public static void deployKjarToMaven(String group, String artifact, String version, String kbaseName, String ksessionName) {
        ...
        bpmnResources.add(new BpmnResource("/repo/test/humanTask.bpmn"));
        bpmnResources.add(new BpmnResource("/repo/test/scriptTask.bpmn"));
        bpmnResources.add(new BpmnResource("/repo/test/signal.bpmn"));
    ...
    private static String convertFileToString(String fileName) { 
        InputStreamReader input = new InputStreamReader(TestDeploymentLoader.class.getResourceAsStream(fileName));
