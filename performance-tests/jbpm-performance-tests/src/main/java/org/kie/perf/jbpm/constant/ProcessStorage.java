...
public enum ProcessStorage {
    ...
    HumanTask("HumanTask.bpmn2", "org.kie.perf.HumanTask"), GroupHumanTask("GroupHumanTask.bpmn2", "org.kie.perf.GroupHumanTask"), ParallelGateway(
            ...
            "IntermediateTimer.bpmn2", "org.kie.perf.IntermediateTimer"), AsyncPrintTask("AsyncPrintTask.bpmn2", "org.kie.perf.AsyncPrintTask"), MultiInstanceSubprocesses(
            "MultiInstanceSubprocesses.bpmn2", "org.kie.perf.MultiInstanceSubprocesses");
