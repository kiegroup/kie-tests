...
public class LRemoteAsyncStartJMSMultiInstanceSubProcesses implements IPerfTest {
    ...
    public void initMetrics() {
        ...
        completedProcess = metrics.meter(MetricRegistry.name(LRemoteAsyncStartJMSMultiInstanceSubProcesses.class, "scenario.process.completed"));
    }

    @Override
    public void execute() {
        ProcessInstance pi = rc.startProcess(ProcessStorage.StartEnd.getProcessDefinitionId());
