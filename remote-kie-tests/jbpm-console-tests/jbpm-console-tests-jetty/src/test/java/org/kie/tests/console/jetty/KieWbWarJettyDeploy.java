package org.kie.tests.console.jetty;

import static org.kie.tests.console.util.TestConstants.*;
import static org.kie.smoke.tests.util.DeployUtil.*;

import org.jboss.shrinkwrap.api.spec.WebArchive;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class KieWbWarJettyDeploy {

    protected static final Logger logger = LoggerFactory.getLogger(KieWbWarJettyDeploy.class);
    
    static WebArchive createTestWar() {
        // Import kie-wb war
        WebArchive war = getWebArchive("org.jbpm", "jbpm-console-ng-showcase", PROJECT_VERSION );
