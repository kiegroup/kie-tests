...
public class KieWbGeneralIntegrationTestMethods {
    ...
    public static void testClassSerialization(URL deploymentUrl, RuntimeEngine engine, String user, String password, IntegrationTestMethods testMethod) {
        ...
        Object [][] inputs = {
                ...
                { "Map<String, Long>", primMap },
                  // complicated to deserialize on client side
//                { "Set<MyType>", typeSet },
...
//                { "Map<MyType, Set<MyType>>", typeSetMap }
        ...
        for( Object [] obj : inputs ) {
            ...
            testMethod.implSpecificTestParamSerialization(deploymentUrl, user, password, engine, obj[1]);
        }
    }
