...
public class AbstractServerSetupTask {
    ...
    public static void deployResource(ManagementClient managementClient, String containerId, String resource, String msg) throws Exception {
        URL resourceUrl = AbstractServerSetupTask.class.getResource(resource);
    ...
    public static void undeployResource(ManagementClient managementClient, String containerId, String resource, String msg) throws Exception {
        ServerDeploymentManager manager = ServerDeploymentManager.Factory.create(managementClient.getControllerClient());
    ...
    private static ServerDeploymentActionResult executePlanAndGetResult(ServerDeploymentManager manager, DeploymentPlan plan) throws Exception {
