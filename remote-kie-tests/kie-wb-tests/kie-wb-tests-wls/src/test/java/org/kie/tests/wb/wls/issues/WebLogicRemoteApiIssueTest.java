...
public class WebLogicRemoteApiIssueTest {

    @Deployment(testable = false, name = "kie-wb-wls")
    public static Archive<?> createWar() {
        return createTestWar();
    }

    private static final Logger logger = LoggerFactory.getLogger(WebLogicRemoteApiIssueTest.class);
    ...
    public void issueTest() throws Exception {
        ...
        KieWbRestIntegrationTestMethods restTests = KieWbRestIntegrationTestMethods.newBuilderInstance()
                ...
                .setTimeoutInSecs(5)
                .build();
        restTests.remoteApiStartScriptProcess(deploymentUrl, user, password);
