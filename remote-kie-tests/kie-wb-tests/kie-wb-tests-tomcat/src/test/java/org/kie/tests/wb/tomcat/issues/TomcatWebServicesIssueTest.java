 ...
 */
package org.kie.tests.wb.tomcat.issues;
...
public class TomcatWebServicesIssueTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TomcatWebServicesIssueTest.class);
