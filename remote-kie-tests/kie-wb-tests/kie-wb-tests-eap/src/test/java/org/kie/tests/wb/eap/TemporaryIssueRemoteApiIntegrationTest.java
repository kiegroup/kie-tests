...
public class TemporaryIssueRemoteApiIntegrationTest extends KieWbWarJbossEapDeploy {
    ...
    private RestIntegrationTestMethods restTests = new RestIntegrationTestMethods(KJAR_DEPLOYMENT_ID, MediaType.APPLICATION_XML);
